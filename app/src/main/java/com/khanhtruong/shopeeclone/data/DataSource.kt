...
fun getProductDataset(): List<ProductData> {
    return listOf(
        ProductData(R.drawable.img_product_1, 10000.0, 20.0, "Ring"),
        ProductData(R.drawable.img_product_2, 20000.0, 2.0, "Nail"),
        ProductData(R.drawable.img_product_3, 30000.0, 10.0, "T-Shirt"),
        ProductData(R.drawable.img_product_4, 40000.0, 1.0, "Lego"),
        ProductData(R.drawable.img_product_5, 60000.0, 4.0, "Necklace"),
        ProductData(R.drawable.img_product_6, 100000.0, 90.0, "Shirt"),
        ProductData(R.drawable.img_product_7, 220000.0, 101.0, "Light"),
        ProductData(R.drawable.img_product_2, 1000000.0, 120.0, "Nail"),
        ProductData(R.drawable.img_product_5, 90000.0, 22.0, "Necklace"),
        ProductData(R.drawable.img_product_1, 300000.0, 15.0, "Ring"),
        ProductData(R.drawable.img_product_3, 40000.0, 5.0, "T-Shirt"),
        ProductData(R.drawable.img_product_4, 80000.0, 89.0, "Lego"),
    )
}